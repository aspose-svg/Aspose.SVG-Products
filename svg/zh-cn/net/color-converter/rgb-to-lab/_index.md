...
{{<section banner>}}
---
h1: 通过 C# 将 RGB 转换为 LAB
h2: 在 Windows、macOS 和 Linux 上使用高速 .NET API 将 RGB 转换为 LAB 颜色
---

{{<section overview>}}
---
h2: 使用 C# 将 RGB 转换为 LAB
---
...
{{<section code-text>}}
---
h2: 将 RGB 转换为 LAB 的 C# 代码示例
title: 将 RGB 转换为 LAB - C#
---

高速 C# 库允许 .NET 开发人员快速有效地将 RGB 转换为 LAB 颜色。几行代码就可以完成颜色转换：
...
1. IConvertibleColor.ToLabString() 方法将RGB转换为LAB颜色，格式为：lab(0%,0%,0%)。
