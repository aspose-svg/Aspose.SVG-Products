...
title: C# 中的 RGB 到 HEX 转换
description: 在 C# 中使用颜色代码并将 RGB 转换为 HEX
...
{{<section banner>}}
---
h1: 通过 C# 将 RGB 转换为 HEX
h2: 在 Windows、macOS 和 Linux 上使用高速 .NET API 将 RGB 转换为 HEX 颜色
---

{{<section overview>}}
---
h2: 使用 C# 将 RGB 转换为 HEX
---
...
{{<section code-text>}}
---
h2: 将 RGB 转换为 HEX 的 C# 代码示例
title: 将 RGB 转换为 HEX - C#
---

高速 C# 库允许 .NET 开发人员快速有效地将 RGB 转换为 HEX 颜色。几行代码就可以完成颜色转换：
...
1. IConvertibleColor.ToHexString() 方法将 RGB 转换为 HEX 颜色，格式为：#000000。
