...
title: C# 中的 RGB 到 HWB 转换
description: 在 C# 中使用颜色代码并将 RGB 转换为 HWB
...
{{<section banner>}}
---
h1: 通过 C# 将 RGB 转换为 HWB
h2: 在 Windows、macOS 和 Linux 上使用高速 .NET API 将 RGB 转换为 HWB 颜色
---

{{<section overview>}}
---
h2: 使用 C# 将 RGB 转换为 HWB
---
...
{{<section code-text>}}
---
h2: 将 RGB 转换为 HWB 的 C# 代码示例
title: 将 RGB 转换为 HWB - C#
---

高速 C# 库允许 .NET 开发人员快速有效地将 RGB 转换为 HWB 颜色。几行代码就可以完成颜色转换：
...
1. IConvertibleColor.ToHwbString() 方法将 RGB 转换为 HWB 颜色，格式为：hwb(0,0%,0%)。
