...
title: 通过 C# 将 JPG 合并到 JPG - Aspose.SVG
description: 在 Windows、macOS 和 Linux 上使用 .NET Core API 将 JPG 合并到 JPG
url: /net/merger/jpg-to-jpg/
family: svg
platformtag: net
feature: merge
informat: &1303802487 JPG
outformat: JPG
...
{{<section banner>}}
---
h1: 通过 C# 将 JPG 合并为 JPG
h2: 用于在 Windows、macOS 和 Linux 上组合 JPG 文件的高速 .NET API
---

{{<section overview>}}
---
h2: 使用 C# 将 JPG 合并为 JPG
---

JPEG 是由联合图像专家组开发的标准图像格式。 JPEG 文件压缩技术经过精心设计和深思熟虑。它去除了多余的颜色数据并提供了极高的压缩比。尽管如此，JPEG 可以显示生动多彩的图像，并以最小的图像尺寸获得更好的图像质量。在许多情况下，您可能需要合并 JPG 图像。使用 [Aspose.SVG for .NET](https://products.aspose.com/svg/net/) API，您可以通过编程方式将 JPG 合并到 JPG。强大的 C# API 帮助您快速、高质量地合并 JPG 文件！

{{<section code-text>}}
---
h2: 将 JPG 合并为 JPG 的 C# 代码示例
title: 将 JPG 合并为 JPG - C#
---

合并多个 JPG 文件并将结果轻松保存为单个 JPG 文件！合并图像可以用几行代码完成：
