...
title: 通过 C# 将 JPG 合并到 GIF - Aspose.SVG
description: 在 Windows、macOS 和 Linux 上使用 .NET Core API 将 JPG 合并到 GIF
...
{{<section banner>}}
---
h1: 通过 C# 将 JPG 合并为 GIF
h2: 用于在 Windows、macOS 和 Linux 上组合 JPG 文件的高速 .NET API
---

{{<section overview>}}
---
h2: 使用 C# 将 JPG 合并到 GIF
---

JPEG 是由联合图像专家组开发的标准图像格式。 JPEG可以显示生动多彩的图像，并以最小的图像尺寸获得更好的图像质量。 GIF 文件具有较小的文件大小，非常适合用于网站徽标、线条艺术和简单卡通。它上传速度很快，因为这些文件通常是低分辨率的。两种文件格式各有优缺点，在很多情况下，您可能需要将 JPG 图像组合起来，然后将它们保存为一个 GIF 文件。使用 [Aspose.SVG for .NET](https://products.aspose.com/svg/net/) API，您可以通过编程方式将 JPG 合并到 GIF。强大的 C# API 帮助您快速、高质量地合并 JPG 文件！

{{<section code-text>}}
---
h2: 将 JPG 合并到 GIF 的 C# 代码示例
title: 将 JPG 合并到 GIF - C#
---

合并多个 JPG 文件并将结果轻松保存为单个 GIF 文件！合并图像可以用几行代码完成：
