...
title: 通过 C# 将 PNG 合并到 BMP - Aspose.SVG
description: 在 Windows、macOS 和 Linux 上使用 C# 将 PNG 合并为 BMP
...
{{<section banner>}}
---
h1: 通过 C# 将 PNG 合并为 BMP
h2: 用于在 Windows、macOS 和 Linux 上组合 PNG 文件的高速 .NET API
---

{{<section overview>}}
---
h2: 使用 C# 将 PNG 合并为 BMP
---

PNG是指一种使用无损压缩的光栅图像文件格式，因此在用户中很受欢迎。 BMP 格式的图形文件是未压缩的位图图像，因此 BMP 图片比 PNG 图片具有更高的分辨率。两种文件格式各有优缺点，在某些情况下，您可能需要合并 PNG 图像并将它们保存为一个 BMP 文件。使用 [Aspose.SVG for .NET](https://products.aspose.com/svg/net/) API，您可以通过编程方式将 PNG 合并到 BMP。强大的 C# API 可帮助您快速、高质量地组合 PNG 文件！

{{<section code-text>}}
---
h2: 将 PNG 合并为 BMP 的 C# 代码示例
title: 将 PNG 合并为 BMP - C#
---

合并多个 PNG 文件并将结果轻松保存为单个 BMP 文件！合并图像可以用几行代码完成：
