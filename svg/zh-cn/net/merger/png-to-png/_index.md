...
title: 通过 C# 将 PNG 合并为 PNG - Aspose.SVG
description: 在 Windows、macOS 和 Linux 上使用 C# 将 PNG 合并为 PNG
url: /net/merger/png-to-png/
family: svg
platformtag: net
feature: merge
informat: &1666188908 PNG
outformat: PNG
...
{{<section banner>}}
---
h1: 通过 C# 将 PNG 合并为 PNG
h2: 用于在 Windows、macOS 和 Linux 上组合 PNG 文件的高速 .NET API
---

{{<section overview>}}
---
h2: 使用 C# 将 PNG 合并为 PNG
---

PNG是指一种使用无损压缩的光栅图像文件格式，因此在用户中很受欢迎。我们可以肯定地说，PNG 已经发展成为最常用的图像文件格式之一。在许多情况下，您可能需要组合 PNG 图像。使用 [Aspose.SVG for .NET](https://products.aspose.com/svg/net/) API，您可以以编程方式将 PNG 合并到 PNG。强大的 C# API 可帮助您快速、高质量地组合 PNG 文件！

{{<section code-text>}}
---
h2: 将 PNG 合并为 PNG 的 C# 代码示例
title: 将PNG合并到PNG - C#
---

高速 C# 库允许 .NET 开发人员快速有效地将 PNG 文件合并为一个 PNG。图像合并可以用几行代码来完成：
...
1. 多张PNG图片将被保存到指定路径的一个PNG文件中。



{{<section documentation>}}

[Aspose.Svg.Rendering.Image](https://reference.aspose.com/svg/net/aspose.svg.rendering.image/) 命名空间提供了特定的设备类以及一些负责渲染的渲染选项类光栅格式：JPEG、PNG、BMP、GIF 和 TIFF。请访问<a href="https://docs.aspose.com/svg/net/how-to-work-with-aspose-svg-api/" target="_blank">我们的文档</a>了解更多关于使用 Aspose.SVG API 函数的信息。
