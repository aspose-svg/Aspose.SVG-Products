...
title: Слияние SVG с изображением с помощью C# - Aspose.SVG
description: Слияние SVG с изображением с помощью C# в Windows, macOS и Linux
...
{{<section banner>}}
---
h1: Объединить SVG в файл растрового изображения через C#
...
{{<section steps>}}
---
h2: Шаги по слиянию SVG с изображением с помощью C#
---
