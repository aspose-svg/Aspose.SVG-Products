...
title: Объединение PNG в PNG с помощью C# - Aspose.SVG
description: Объединение PNG в PNG с помощью C# в Windows, macOS и Linux
url: /net/merger/png-to-png/
family: svg
platformtag: net
feature: merge
informat: &868954367 PNG
outformat: PNG
...
{{<section banner>}}
---
h1: Объединить PNG в PNG через C#
h2: Высокоскоростной .NET API для объединения файлов PNG в Windows, macOS и Linux.
---

{{<section overview>}}
---
h2: Объединение PNG в PNG с помощью C#
---

PNG относится к типу формата файла растрового изображения, который использует сжатие без потерь, что делает его популярным среди пользователей. Можно с уверенностью сказать, что PNG превратился в один из наиболее часто используемых форматов файлов изображений. Во многих случаях вам может понадобиться объединить изображения PNG. С помощью API [Aspose.SVG для .NET](https://products.aspose.com/svg/net/) вы можете программно объединить PNG в PNG. Мощный C# API поможет вам быстро и качественно объединить файлы PNG!

{{<section code-text>}}
---
h2: Пример кода C# для объединения PNG в PNG
title: Объединить PNG в PNG — C#
---

Высокоскоростная библиотека C# позволяет разработчикам .NET быстро и эффективно объединять файлы PNG в один PNG. Слияние изображений можно выполнить с помощью нескольких строк кода:
...
{{<section steps>}}
---
h2: 'Шаги по объединению PNG в PNG с помощью C #'
---
...
1. Несколько изображений PNG будут сохранены в один файл PNG по указанному пути.
