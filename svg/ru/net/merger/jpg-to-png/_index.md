...
title: Объединение JPG в PNG через C# - Aspose.SVG
...
{{<section banner>}}
---
h1: Объединить JPG в PNG через C#
h2: Высокоскоростной .NET API для объединения файлов JPG в Windows, macOS и Linux.
---

{{<section overview>}}
---
h2: Объединение JPG в PNG с помощью C#
---

JPEG — это стандартный формат изображения, разработанный Объединенной группой экспертов по фотографии. JPEG может отображать яркие и красочные изображения и достигать лучшего качества изображения при наименьшем размере изображения. PNG относится к типу формата файла растрового изображения, который использует сжатие без потерь, что делает его популярным среди пользователей. Каждый формат изображения имеет свои плюсы и минусы, и во многих случаях вам может понадобиться объединить изображения JPG и сохранить их как один файл PNG. С помощью API [Aspose.SVG для .NET](https://products.aspose.com/svg/net/) вы можете программно объединить JPG в PNG. Мощный C# API поможет вам быстро и качественно объединить файлы JPG!

{{<section code-text>}}
---
h2: Пример кода C# для объединения JPG в PNG
title: Объединить JPG в PNG — C#
---

Объедините несколько файлов JPG и легко сохраните результат в виде одного PNG! Объединение изображений можно выполнить с помощью нескольких строк кода:
...
{{<section steps>}}
---
h2: Шаги по слиянию JPG с PNG с помощью C#
---
...
1. Несколько изображений JPG будут сохранены в один файл PNG по указанному пути.
