...
title: Объединение PNG в JPG через C# - Aspose.SVG
description: Объединение PNG в JPG с помощью C# в Windows, macOS и Linux
...
{{<section banner>}}
---
h1: Объединение PNG в JPG через C#
h2: Высокоскоростной .NET API для объединения файлов PNG в Windows, macOS и Linux.
---

{{<section overview>}}
---
h2: Объединение PNG в JPG с помощью C#
---

PNG относится к типу формата файла растрового изображения, который использует сжатие без потерь, что делает его популярным среди пользователей. Иногда вы можете столкнуться с очень важным вопросом о том, следует ли хранить ваши цифровые изображения в виде файлов JPG или PNG. Это два самых популярных типа файлов растровых изображений, используемых в Интернете, и оба формата файлов имеют свои плюсы и минусы. Во многих случаях вам может понадобиться объединить изображения PNG и сохранить их как один файл JPG. С помощью API [Aspose.SVG для .NET](https://products.aspose.com/svg/net/) вы можете программно объединить PNG в JPG. Мощный C# API поможет вам быстро и качественно объединить файлы PNG!

{{<section code-text>}}
---
h2: Пример кода C# для объединения PNG в JPG
title: Объединение PNG в JPG — C#
---

Объедините несколько файлов PNG и легко сохраните результат в виде одного JPG! Объединение изображений можно выполнить с помощью нескольких строк кода:
...
{{<section steps>}}
---
h2: 'Шаги по объединению PNG в JPG с помощью C #'
---
...
1. Несколько изображений PNG будут сохранены в один файл JPG по указанному пути.
