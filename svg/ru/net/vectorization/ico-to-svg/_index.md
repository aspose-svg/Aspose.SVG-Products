...
title: Преобразование ICO в SVG — код C# и онлайн-векторизатор
description: Векторизация растрового изображения в C#. Преобразуйте ICO в SVG и получите все преимущества векторной графики. Попробуйте онлайн векторизатор изображений бесплатно!
...
{{<section banner>}}
---
h1: Преобразование ICO в SVG — код C# и онлайн-векторизатор
...
1. Векторизировать ICO из указанного файла. Метод [Vectorize()](https://reference.aspose.com/svg/net/aspose.svg.imagevectorization/imagevectorizer/vectorize/) берет путь к файлу изображения и возвращает SVGDocument.
