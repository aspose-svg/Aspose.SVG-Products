...
h2: Преобразование изображения в вектор в C#. Поддерживаются форматы JPG, PNG, BMP, GIF, TIFF и ICO.
---
...
Вы можете векторизовать изображение с помощью Aspose.SVG для .NET API в режиме реального времени. Попробуйте наш бесплатный векторизатор изображений и преобразуйте информацию о цвете пикселей в простые геометрические объекты! Выберите изображение в формате PNG для векторизации.
...
Вы можете узнать больше о векторизации изображений, перейдя по ссылке - <a href="https://products.aspose.com/svg/{{lang.url-fragment}}net/vectorization/png-to-vector"> PNG в вектор.</a>
