...
<b>Sourceк</b> — эта область содержит исходное растровое изображение для векторизации.
...
Вы можете узнать больше о векторизации изображений, перейдя по ссылке - <a href="https://products.aspose.com/svg/{{lang.url-fragment}}net/vectorization/image-to-svg/" >Преобразование растрового изображение в SVG.</a>
