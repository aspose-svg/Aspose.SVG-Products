---
title: Merge SVG to JPEG with C# Core - Aspose.SVG
description: Merge SVG to JPEG using .NET Core API on Windows, macOS & Linux
...
using (var document3 = new SVGDocument("document3.svg"))
{
    ...
    using var device = new Aspose.Svg.Rendering.Image.ImageDevice("result.jpeg");
    // Merge SVG to JPEG
...
1.  Multiple SVG files will be saved to the JPEG image on the specified path.</br></br>
