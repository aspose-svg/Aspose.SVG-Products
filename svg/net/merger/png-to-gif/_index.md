...
description: Merge PNG to GIF using .NET Core API on Windows, macOS & Linux
...
1. Multiple PNG images will be saved into one GIF file on the specified path.</br></br>
