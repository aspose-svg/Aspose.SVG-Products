...
description: Load, Save and Convert SVG to GIF using .NET Core API on Windows, macOS & Linux
...
{{< app/svg/converter SVG GIF TIFF PNG "JPG|JPEG" BMP PDF XPS >}}
using Aspose.Svg;
