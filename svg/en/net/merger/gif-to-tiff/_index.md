...
{{<section code-text>}}
---
h2: C# code example to merge GIF to TIFF
title: Merge GIF to TIFF - C#
---
...
{{<section steps>}}
---
h2: Steps to Merge GIF to TIFF using C#
---
