---
title: Merge SVG to Image with C# Core - Aspose.SVG
description: Merge SVG to Image using .NET Core API on Windows, macOS & Linux
url: /net/merger/svg-to-image/
family: svg
platformtag: net
feature: merge
informat: SVG
outformat: JPEG BMP GIF PNG TIFF 
...
{{% blocks/products/pf/agp/content h2="Merge SVG to Raster Image file format Using C#" %}}

SVG is one of the most used vector image formats for website building and print graphics to achieve scalability. But sometimes, you need to merge SVG files and save them as one raster image. A raster image represents a two-dimensional grid of pixels; it may store data in uncompressed or compressed formats. Images are widely taken to transmit pictures over the network and display photos and graphics on web pages and cloud drive repositories. With [Aspose.SVG for .NET](https://products.aspose.com/svg/net/) API, you can merge SVG to Image programmatically. Powerful C# API allows you to transform your SVG files quickly and in high quality.</br></br>
...
1.  Multiple SVG files will be saved to the image on the specified path.</br></br>
