...
{{<section code-text>}}
---
h2: C# code example to convert HEX to HSL
title: Convert HEX to HSL - C#
---

The high-speed C# library allows .NET developers to quickly and efficiently convert HEX to HSL color. Color conversion can be done with a few lines of code:
...
{{<section steps>}}
---
h2: Steps to convert HEX to HSL using C#
---
...
1. The IConvertibleColor.ToHslString() method converts HEX to HSL color in the format: hsl(0,0%,0%).
