...
title: RGB to LAB Conversion in C#
...
{{<section code-text>}}
---
h2: C# code example to convert RGB to LAB
title: Convert RGB to LAB - C#
---

The high-speed C# library allows .NET developers to quickly and efficiently convert RGB to LAB color. Color conversion can be done with a few lines of code:
...
{{<section steps>}}
---
h2: Steps to convert RGB to LAB using C#
---
...
1. The IConvertibleColor.ToLabString() method converts RGB to LAB color in the format: lab(0%,0%,0%).
