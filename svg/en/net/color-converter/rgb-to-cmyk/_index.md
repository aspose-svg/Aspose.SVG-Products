...
title: RGB to CMYK Conversion in C#
description: Work with color codes and convert RGB to CMYK in C#
...
{{<section code-text>}}
---
h2: C# code example to convert RGB to CMYK
title: Convert RGB to CMYK - C#
---

The high-speed C# library allows .NET developers to quickly and efficiently convert RGB to CMYK color. Color conversion can be done with a few lines of code:
...
{{<section steps>}}
---
h2: Steps to convert RGB to CMYK using C#
---
...
1. The IConvertibleColor.ToCmykString() method converts RGB to CMYK color in the format: cmyk(0%,0%,0%,0%).
