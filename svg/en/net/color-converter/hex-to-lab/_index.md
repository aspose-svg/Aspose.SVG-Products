...
title: HEX to LAB Conversion in C#
...
{{<section code-text>}}
---
h2: C# code example to convert HEX to LAB
title: Convert HEX to LAB - C#
---

The high-speed C# library allows .NET developers to quickly and efficiently convert HEX to LAB color. Color conversion can be done with a few lines of code:
...
{{<section steps>}}
---
h2: Steps to convert HEX to LAB using C#
---
...
1. The IConvertibleColor.ToLabString() method converts HEX to LAB color in the format: lab(0%,0%,0%).
