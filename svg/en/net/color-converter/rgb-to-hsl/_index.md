...
title: RGB to HSL Conversion in C#
...
{{<section code-text>}}
---
h2: C# code example to convert RGB to HSL
title: Convert RGB to HSL - C#
---

The high-speed C# library allows .NET developers to quickly and efficiently convert RGB to HSL color. Color conversion can be done with a few lines of code:
...
{{<section steps>}}
---
h2: Steps to convert RGB to HSL using C#
---
...
1. The IConvertibleColor.ToHslString() method converts RGB to HSL color in the format: hsl(0,0%,0%).
