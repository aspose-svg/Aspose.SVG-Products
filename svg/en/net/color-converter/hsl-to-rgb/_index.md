...
title: HSL to RGB Conversion in C#
description: Work with color codes and convert HSL to RGB in C#
...
{{<section banner>}}
---
h1: Convert HSL to RGB via C#
h2: Use High-speed .NET API to Convert HSL to RGB color on Windows, macOS & Linux
---

{{<section overview>}}
---
h2: Convert HSL to RGB Using C#
---
...
{{<section code-text>}}
---
h2: C# code example to convert HSL to RGB
title: Convert HSL to RGB - C#
---

The high-speed C# library allows .NET developers to quickly and efficiently convert HSL to RGB color. Color conversion can be done with a few lines of code:
...
{{<section steps>}}
---
h2: Steps to convert HSL to RGB using C#
---
...
1. The IConvertibleColor.ToRgbString() method converts HSL to RGB color in the format: rgb(0, 0, 0).
