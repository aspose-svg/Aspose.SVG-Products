...
title: HEX to RGB Conversion in C#
description: Work with color codes and convert HEX to RGB in C#
...
{{<section code-text>}}
---
h2: C# code example to convert HEX to RGB
title: Convert HEX to RGB - C#
---

The high-speed C# library allows .NET developers to quickly and efficiently convert HEX to RGB color. Color conversion can be done with a few lines of code:
...
{{<section steps>}}
---
h2: Steps to convert HEX to RGB using C#
---
...
1. The IConvertibleColor.ToRgbString() method converts HEX to RGB color in the format: rgb(0, 0, 0).
