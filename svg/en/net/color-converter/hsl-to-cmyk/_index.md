...
title: HSL to CMYK Conversion in C#
...
{{<section code-text>}}
---
h2: C# code example to convert HSL to CMYK
title: Convert HSL to CMYK - C#
---

The high-speed C# library allows .NET developers to quickly and efficiently convert HSL to CMYK color. Color conversion can be done with a few lines of code:
...
{{<section steps>}}
---
h2: Steps to convert HSL to CMYK using C#
---
...
1. The IConvertibleColor.ToCmykString() method converts HSL to CMYK color in the format: cmyk(0%,0%,0%,0%).
