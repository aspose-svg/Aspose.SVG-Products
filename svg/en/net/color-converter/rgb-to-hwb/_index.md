...
title: RGB to HWB Conversion in C#
...
{{<section code-text>}}
---
h2: C# code example to convert RGB to HWB
title: Convert RGB to HWB - C#
---

The high-speed C# library allows .NET developers to quickly and efficiently convert RGB to HWB color. Color conversion can be done with a few lines of code:
...
{{<section steps>}}
---
h2: Steps to convert RGB to HWB using C#
---
...
1. The IConvertibleColor.ToHwbString() method converts RGB to HWB color in the format: hwb(0,0%,0%).
