...
steps[2].text: "Initialize an instance of the ImageVectorizer class and specify Configuration properties."
...
supply: "Convert text to vector paths online quickly and efficiently on any platform."
steps[1].name: "Install Aspose.SVG for .NET."
steps[1].text: "Add a .NET library reference to your C# project."
steps[1].image: "https://products.aspose.com/svg/images/vectorization/step0.png"
...
qs[1].text: "Aspose.SVG allows you vectorize SVG text in any way - online or programmatically. You can convert text to vector in real-time using Online Text to Vector application that transforms your texts in SVG file quickly and with high quality. On other hand, you can use Aspose.SVG for .NET API to vectorize text programmatically."
qs[2].name: "What does text vectorization mean?"
qs[2].text: "Text vectorization is the process of converting text into a variety of vector paths and geometrical forms. In vectorized SVG text, all font glyphs are replaced by a combination of XML text tags. The text is converted to vector shapes and cannot be edited. This prevents casual users from opening and editing this file in a text editor."
