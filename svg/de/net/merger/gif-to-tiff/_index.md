...
<p> Combine multiple GIF files and save the result as a single TIFF file easily! Merging images can be done with a few lines of code:</p></br>
...
1. Multiple GIF images will be saved into one TIFF file on the specified path.</br></br>
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/svg/net/merger/gif-to-gif/" name="GIF to GIF" description="Graphical Interchange Format" >}}
