...
title: C# 中 HSV 到 HSL 的转换
description: 在 C# 中使用颜色代码并将 HSV 转换为 HSL
...
{{<section banner>}}
---
h1: 通过 C# 将 HSV 转换为 HSL
h2: 在 Windows、macOS 和 Linux 上使用高速 .NET API 将 HSV 转换为 HSL 颜色
---

{{<section overview>}}
---
h2: 使用 C# 将 HSV 转换为 HSL
---
...
{{<section code-text>}}
---
h2: 将 HSV 转换为 HSL 的 C# 代码示例
title: 将 HSV 转换为 HSL - C#
---

高速 C# 库允许 .NET 开发人员快速有效地将 HSV 转换为 HSL 颜色。几行代码就可以完成颜色转换：
...
1. IConvertibleColor.ToHslString() 方法将 HSV 转换为 HSL 颜色，格式为：hsl(0,0%,0%)。
