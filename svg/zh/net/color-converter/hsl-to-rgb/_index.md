...
{{<section banner>}}
---
h1: 通过 C# 将 HSL 转换为 RGB
h2: 在 Windows、macOS 和 Linux 上使用高速 .NET API 将 HSL 转换为 RGB 颜色
---

{{<section overview>}}
---
h2: 使用 C# 将 HSL 转换为 RGB
---
...
{{<section code-text>}}
---
h2: 将 HSL 转换为 RGB 的 C# 代码示例
title: 将 HSL 转换为 RGB - C#
---

高速 C# 库允许 .NET 开发人员快速有效地将 HSL 转换为 RGB 颜色。几行代码就可以完成颜色转换：
...
1. IConvertibleColor.ToRgbString() 方法将 HSL 转换为 RGB 颜色，格式为：rgb(0, 0, 0)。
