...
title: 通过 C# 将 GIF 合并到 PNG - Aspose.SVG
description: 在 Windows、macOS 和 Linux 上使用 .NET Core API 将 GIF 合并为 PNG
...
{{<section banner>}}
---
h1: 通过 C# 将 GIF 合并为 PNG
h2: 用于在 Windows、macOS 和 Linux 上组合 GIF 文件的高速 .NET API
---

{{<section overview>}}
---
h2: 使用 C# 将 GIF 合并为 PNG
---

GIF 文件具有较小的文件大小，这使得它们非常适合用于徽标、线条艺术和简单卡通的网站。 GIF 和 PNG 是 Web 上最流行的图形文件格式。两种文件格式各有利弊，在某些情况下，您可能需要合并 GIF 图像并将它们保存为一个 PNG 文件。使用 [Aspose.SVG for .NET](https://products.aspose.com/svg/net/) API，您可以以编程方式将 GIF 合并到 PNG。强大的 C# API 可帮助您快速、高质量地组合 GIF 文件！

{{<section code-text>}}
---
h2: 将 GIF 合并为 PNG 的 C# 代码示例
title: 将 GIF 合并为 PNG - C#
---

合并多个 GIF 文件并将结果轻松保存为单个 PNG 文件！合并图像可以用几行代码完成：
