...
title: 通过 C# 将 SVG 合并到 TIFF - Aspose.SVG
description: 在 Windows、macOS 和 Linux 上使用 C# API 将 SVG 合并到 TIFF
...
{{<section banner>}}
---
h1: 通过 C# 将 SVG 合并到 TIFF
h2: 用于在 Windows、macOS 和 Linux 上组合 SVG 文件的高速 .NET API
---

{{<section overview>}}
---
h2: 使用 C# 将 SVG 合并到 TIFF
---

SVG 是用于网站构建和打印图形以实现可扩展性的最常用格式之一。但有时，您需要合并 SVG 文件并将它们保存为一个光栅图像。 TIFF 是一种流行的存储深色图像的格式。使用 [Aspose.SVG for .NET](https://products.aspose.com/svg/net/) API，您可以通过编程方式将 SVG 合并到 TIFF。强大的 C# API 可帮助您快速、高质量地组合 SVG 文件！

{{<section code-text>}}
---
h2: 将 SVG 合并到 TIFF 的 C# 代码示例
title: 将 SVG 合并到 TIFF - C#
---
...
1.调用[Render()](https://reference.aspose.com/svg/net/aspose.svg.rendering/renderer-1/)方法将SVG合并为TIFF图像。
1. 多个 SVG 文件将被保存到指定路径的 TIFF 图像中。
