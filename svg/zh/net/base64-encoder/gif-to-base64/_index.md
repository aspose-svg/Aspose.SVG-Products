...
title: 将 GIF 转换为 Base64 - 在线编码器和 C# 代码
description: 在线或在 C# 中将 GIF 转换为 Base64，并使用编码字符串作为数据 URI。 将其嵌入 HTML、CSS、XML、JSON 等。
...
{{<section banner>}}
---
h1: 在线或使用 C# 将 GIF 转换为 Base64
h2: 将 GIF 编码为 Base64 字符串并将其用于数据 URI。 您可以在线或使用 C# 对图像进行编码。
---
